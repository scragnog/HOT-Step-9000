...
export const translations = {
    en: {
        ...
        taskDescAutoWrite: 'Describe your song and let the AI write lyrics, style, and metadata for you.',
    ...
    zh: {
        ...
        taskDescAutoWrite: '描述你想要的歌曲，AI 将为你自动生成歌词、风格和元数据。',
    ...
    ja: {
        ...
        taskDescAutoWrite: '曲を説明すると、AIが歌詞、スタイル、メタデータを自動生成します。',
    ...
    ko: {
        ...
        taskDescAutoWrite: '노래를 설명하면 AI가 가사, 스타일, 메타데이터를 자동으로 생성합니다.',
