...
export const translations = {
    en: {
        ...
        schedulerBeta57Desc: 'Beta(0.5, 0.7) — smooth S-curve that front-loads structural steps. From RES4LYF.',
        schedulerBetaDesc: 'Custom beta distribution schedule. Adjust α and β to control step density.',
        schedulerCosineDesc: 'Cosine annealing — balanced S-curve with gentle transitions.',
        schedulerPowerDesc: 'Power-law t^p. p>1 = structural focus, p=1 = linear, p<1 = detail focus.',
