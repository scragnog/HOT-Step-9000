...
interface LmCotAccordionProps {
    ...
    onLmBackendChange: (val: 'pt' | 'vllm' | 'custom-vllm' | 'llama-cpp') => void;
    // LM Model
    lmModel: string;
    ...
    const content = (
                <div className={embedded ? "space-y-4" : "bg-white dark:bg-suno-card rounded-b-xl rounded-t-none border border-t-0 border-zinc-200 dark:border-white/5 p-4 space-y-4"}>
                    ...
                    <div className="space-y-1.5">
                        ...
                        <select value={lmBackend} onChange={(e) => onLmBackendChange(e.target.value as 'pt' | 'vllm' | 'custom-vllm' | 'llama-cpp')} className={selectClass}>
