 ...
 *
 * Stores presets in localStorage (`ace-scaleOverridePresets`).
 * Used in both the Create page (AdaptersAccordion) and Lyric Studio (ArtistPageSidebar).
 */
...
const STORAGE_KEY = 'ace-scaleOverridePresets';
